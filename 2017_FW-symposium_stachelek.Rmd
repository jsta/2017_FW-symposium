...
\multicolumn{2}{c}{}
& \multicolumn{2}{c}{Water Residence Time} \\
\multicolumn{2}{c}{}
 &  \multicolumn{1}{c}{Low}
 & \multicolumn{1}{c}{High} \\
\cline{3-4}
& \rotatebox[origin=c]{90}{Low} & Low & High \\
\cline{3-4}
\rotatebox[origin=c]{90}{Connectivity} & \rotatebox[origin=c]{90}{Medium} & Medium & Medium \\
\cline{3-4}
& \rotatebox[origin=c]{90}{High} & Low & \\
\cline{3-4}
\end{tabular}
\end{center}
...
\bgroup
\pgfdeclareimage[width=\paperwidth]{empty}{images/PIA03434_hires.jpg}
