...
Milstead found much less nutrient retention than previous studies. 

## Does shorter residence explain the discrepancy?

### What is water residence time?

$$t_w=\frac{V_L}{Q}$$

```{r echo=FALSE, cache=TRUE, message=FALSE, warning=FALSE, fig.height=2.7, fig.width=5}
...
\small
```{r echo=FALSE,caption="conceptual table", results="asis"}
pander::pandoc.table(
    data.frame(
    "Connectivity" = c("Headwater", "Isolated", "Primary-Flowthrough", "Secondary-Flowthrough"),
    "Ground\nSurfacewater" = c("GW", "GW", "SW", "SW"),
    "Nutrient\nRetention" = c("Low", "High", "Low", "High"),
    "Water\nResidence\n\n\nTime\n" = c("Low", "High", "Low", "High"), check.names = FALSE)
